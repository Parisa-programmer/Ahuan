    ...
    <v-dialog v-if="loginDialog" class="rounded-lg loginDialog" v-model="loginDialog" style="z-index: 2" width="450">
      <v-card class="pa-2 hideOver relative" style="border-radius: 10px;">
        ...
        <v-row
          ...
          justify="center">
          <img class="my-6" src="/folders/image/success.png" alt="" width="130px">
        ...
        <v-row justify="center">
          ...
          <span v-else-if="loginType == 'login' && loginStep == 2 && UserType != 2"
            class="body text-center widthAll grey--text text--darken-1" style="font-family: Byekan !important;">
            {{ loginForm.phone }}
