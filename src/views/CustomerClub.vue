            ...
            <v-row class="heightAll" align="center">
              <div class="px-6 relative">
                ...
                <div style="z-index:222">
                  <h2 class="font-small-title-xs mb-3">باشگاه مشتریان آهوان</h2>
      ...
      <div class="indexDiv ">
        <v-row>
          ...
          <v-col cols="12" md="6" class="">
            ...
            <div>
              <p class="text-justify mt-3 mt-sm-3 font-small-xs paragraph " style="font-family:Byekan !important">
                شما می‌توانید با روش‌های ذیل امتیازات خود را افزایش داده و به عضویت کارت‌هایی با رتبه بهتر دست یابید:
              </p>
              <ol class="mr-6 mt-4 mb-12 ">
                <li class="mt-2">ثبت نام و تکمیل پروفایل کاربری</li>
                <li class="mt-2">معرفی محصولات آهوان به دیگر دوستان</li>
                <li class="mt-2" style="font-family:Byekan !important">ثبت نظر و امتیاز به محصولات هتل-پرواز-تور</li>
                <li class="mt-2" style="font-family:Byekan !important">ثبت خاطرات نو در برنامه وبلاگ آهوان(خاطرات شما)
                </li>
                <li class="mt-2" style="font-family:Byekan !important">شرکت در نظرسنجی و مسابقات ویژه</li>
                <li class="mt-2" style="font-family:Byekan !important">خرید محصولات مختلف سایت</li>
              </ol>
