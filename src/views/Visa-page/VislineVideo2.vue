          ...
          <v-col cols="12" md="6">
            <div class="relative" oncontextmenu="return false;">
              <video id="video1" :controls="play1 == true ? true : false" controlsList="nodownload" loop
                @pause="play1 = false">
                <source src="@/assets/video/visline2.mp4" type="video/mp4">
          ...
          <v-col cols="12" md="6" class="">
            <v-row class="">
              <p class="mt-2 mt-sm-6 widthAll white--text text-justify">
                نرم افزار ویزلاین با استفاده از تجربه گذشته مسافران و در نظرگرفتن شرایط و قوانین جدید کشورها و همچنین با
                تکیه به تکنولوژی جدید هوش مصنوعی با طرح چند سؤال ساده، کوتاه‌ترین و کم‌هزینه‌ترین مسیر را جهت اخذ ویزا به
                شما پیشنهاد می‌دهد.
              </p>
            </v-row>
