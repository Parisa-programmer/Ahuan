                  ...
                  <v-row>
                    <v-col cols="12" md="6">
                      <ul class="mt-md-9 mr-md-6">
                        ...
                        <li class="my-3 grey--text text--darken-3 bold text-tour">اقامت در هتل هاي پنج ستاره همراه با صبحانه</li>
                ...
                <div class="widthAll" v-else-if="tab == 2">
                  <v-row>
                    <v-col cols="12" md="12">
                      ...
                      <ul class="my-6">
                        <li class="my-3 grey--text text--darken-3 bold text-tour text-justify">اصل شناسنامه ها + اصل کارت ملی</li>
                        ...
                        <li class="my-3 grey--text text--darken-3 bold text-tour text-justify">اصل پاسپورت های قدیمی + کپی از تمام صفحات استفاده شده
                          ...
                          <span v-if="showMore1" class="grey--text text--darken-3">پاسپورتهای قدیمی (ویزا و مهرهای ورود و خروج)</span>
                        </li>
                        <li v-if="showMore1" class="my-3 grey--text text--darken-3 bold text-tour text-justify">تمام مدارک فارسی جهت ارائه به سفارت اسپانیا باید به زبان انگلیسی ترجمه شوند. تمکن و گواهی اشتغال صادر شده به زبان انگلیسی پذیرفته می شوند.</li>
                        <li v-if="showMore1" class="my-3 grey--text text--darken-3 bold text-tour text-justify">3 قطعه عکس جدید 5/4*5/3 (3 ماه اخیر) رنگی با زمینه سفید، مستقیم رو به دوربین، 80 درصد عکس صورت باشد و در هیچ پاسپورت یا ویزای قبلی استفاده نشده باشد.</li>
                      ...
                      <ul class="my-6">
                        ...
                        <li v-if="showMore2" class="my-3 grey--text text--darken-3 bold text-tour text-justify">کارمندان شرکت های خصوصی: گواهی اشتغال به کار + لیست سوابق بیمه با مهر سازمان تامین اجتماعی + قرارداد کار و فیش حقوقی (در صورت وجود)
                        </li>
                        ...
                        <li v-if="showMore2" class="my-3 grey--text text--darken-3 bold text-tour text-justify">اساتید و اعضا هیات علمی دانشگاه: گواهی اشتغال به کار + حکم کارگزینی با مهر + فیش حقوقی آخر با مهر
                        </li>
                      ...
                      <ul class="my-6">
                        ...
                        <li class="my-3 grey--text text--darken-3 bold text-tour text-justify">نامه تمکن به انگلیسی + گردش 3 ماه آخر همان حساب به انگلیسی با مهر و امضاء بانک صادر شده در کمتر از 
                          <span v-if="!showMore3"> ...</span>
                          <span v-if="!showMore3" class=" mx-3 cursorPointer see-more" @click="showMore3 = true">مشاهده بیشتر</span>
                          <span v-if="showMore3" class="grey--text text--darken-3">10 روز قبل از تاریخ انگشت نگاری (به ازای هر نفرحداقل 100 میلیون تومان)</span>
                          
                        </li>
                        <li v-if="showMore3" class="my-3 grey--text text--darken-3 bold text-tour text-justify">در صورتیکه فرزند زیر 18 سال بدون یکی از والدین سفر می کند، رضایت نامه
                ...
                <div class="widthAll" v-else-if="tab == 3">
                  <v-row>
                    <ul class="my-6 mr-6">
                      ...
                      <li class="my-3 grey--text text--darken-3 bold text-tour">
                        مسافرین محترمی کهدر 4 سال گذشته از سفارت فرانسه دارای ویزای شنگن بوده‌اند،کلیه ی مراحل اخذ ویزای ایشان در سفارت فراسه به صورت غیر حضوری انجام خواهد شد.
                      </li>
                    </ul>
                  </v-row>  
                </div>
