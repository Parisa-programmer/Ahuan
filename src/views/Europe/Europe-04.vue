                  ...
                  <v-row>
                    <v-col cols="12" md="6">
                      <ul class="mt-md-9 mr-md-6">
                        ...
                        <li class="my-3 grey--text text--darken-3 bold text-tour">گشت شهری با اتوبوس‌های توریستی به همراه تورلیدرفارسی زبان</li>
                      </ul>
                    </v-col>
                    ...
                    <v-col cols="12" md="12">
                      ...
                      <ul class="my-6">
                        ...
                        <li v-if="showMore1" class="my-3 grey--text text--darken-3 bold text-tour text-justify">
                          تمام مدارک فارسی جهت ارائه به سفارت فرانسه باید به زبان انگلیسی ترجمه شوند. (مدارک صادر شده به انگلیسی پذیرفته می شوند.)                         
                        </li>
                        <li v-if="showMore1" class="my-3 grey--text text--darken-3 bold text-tour text-justify">
                          اصل پاسپورت امضا شده با حداقل 6 ماه اعتبار از تاریخ سفر و 2 صفحه خالی رو به روی هم + کپی از تمام صفحات ویزاهای شنگن، کانادا، آمریکا و انگلیس موجود در پاسپورت 
                        </li>
                        <li v-if="showMore1" class="my-3 grey--text text--darken-3 bold text-tour text-justify">
