  ...
  <div class="mt-9 mt-sm-12 pt-12">
    <v-row justify="center">
      <div class="widthAll relative">
        <img class="widthAll backgroundImageTour" src="@/assets/image/tour/tour-background11.jpg" alt="">
        <div class="tourImageBackground"></div>
      </div>
      <div class="mb-12 indexDiv main-div" style="z-index: 3">
        <div>
          <h1 class="white--text countryNmae px-12 d-inline-block">دبی _ 5 شب و 6 روز</h1>
        </div>
        <div>
              ...
              <v-col cols="12" lg="12">
                <v-row class="mb-2" justify="center">
                  <v-data-table :headers="pricesHeaderDubai" hide-default-footer :items="pricesItemsDubai"
                    :items-per-page="50" class="tabelTourId even-odd-tabel rounded-lg"
...
export default {
  ...
  created() {
    // console.log(store);
    document.title = 'تور 5 شب دبی|تور لحظه آخری دبی'
    let newObjectDate4 = [
      {
