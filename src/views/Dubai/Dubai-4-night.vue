    ...
    <v-row justify="center">
      <div class="widthAll relative">
        <img
          ...
          src="@/assets/image/tour/tour-background10.jpg"
          alt=""
        />
              ...
              <v-col cols="12" md="12">
                <ul class="mr-md-6">
                  ...
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                    بلیت رفت و برگشت با باس 300 - 600
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                    ویزای توریستی 14 روزه دبی
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                    بیمه مسافرتی تا سقف 10.000 یورو برای زیر 60 سال
                  </li>
                </ul>
              </v-col>
            </v-row>
              ...
              <v-col cols="12" md="12">
                ...
                <ul class="my-6 mr-9">
                  ...
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour text-justify"
                  >
                    اسکن پاسپورت - شناسنامه - کارت ملی - یک قطعه عکس
                  </li>
                </ul>
              </v-col>
            </v-row>
              ...
              <v-col cols="12" md="12">
                ...
                <ul class="my-6 mr-9">
                  ...
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour text-justify"
                  >
                    کلیه پروازها و هتل ها چارتر و غیر قابل استرداد و تغییر تاریخ
                    میباشد.
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour text-justify"
                  >
                    نرخ کودک بدون تخت 6500000 تومان میباشد که با توجه به تاریخ
                    سفر متغیر میباشد.
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour text-justify"
                  >
                    مسافرین بالای 70 سال می بایست به همراه همسر یا یکی از
                    فرزندان خود مسافرت نمایند.
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour text-justify"
                  >
                    ...
                    تومان محاسبه شده است و با توجه به تاریخ سفر باید مجددا چک
                    شود
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour text-justify"
                  >
                    ...
                    تومان محاسبه شده است در صورت هرگونه افزایش نرخ مابه تفاوت
                    محاسبه خواهد شد.
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour text-justify"
                  >
                    با توجه به محدودیت های موجود در ترانسفر فرودگاهی بعضی از هتل
                    ها در مناطق دبی هزینه ترنسفر بطور مجزا محاسبه و اضافه
                    میگردد.
                  </li>
                </ul>
              </v-col>
    ...
    meta: [
      {
        name: "description",
        content:
          "شرکت آهوان با بیش از 50 سال سابقه مجری مستقیم انواع تورهای دبی است. تورهای ارزان تا لوکس دبی به همراه لیست قیمت هتل‌ها از تهران و سایر شهرها",
      },
    ],
  },
  components: {
