      ...
      <div class="mb-12 indexDiv main-div" style="z-index: 3">
        <div>
          <span class="white--text countryNmae px-12"
            >3 شب سنت پترزبورگ + 3 شب مسکو
          </span>
        </div>
        <div>
          <b class="white--text px-12 tour-date"> ویژه شب های سفید </b>
        </div>
        ...
        <v-row class="white py-md-9 px-sm-6">
            ...
            <v-row>
              <v-col cols="12" md="6" class="pr-6 pr-sm-0">
                <ul class="mt-md-9 mr-md-6">
                  ...
                  <li class="my-3 red--text text--darken-3 bold text-tour">
                    پرواز ماهان ایر رفت به سنت پترزبورگ و برگشت از مسکو
                  </li>
                  <li class="my-3 red--text text--darken-3 bold text-tour">
                    تور بصورت گروهی و لیدر فارسی زبان از تهران تا برگشت همراه
                    مسافر می باشد.
                  </li>
                  <li class="my-3 grey--text text--darken-3 bold text-tour">
                    به کلیه سنین حتی کودکان زیر 2 سال مبلغ 115$ بابت ویزای
                    توریستی اضافه خواهد شد.
                  </li>
                </ul>
                <v-row justify="center" class="mt-6">
                  <v-btn @click="tab = 4" dark class="red px-9"
                    >مشاهده جزئیات سفر</v-btn
                  >
                </v-row>
              </v-col>
              ...
              <v-col cols="12" md="6" class="mb-6 mb-md-0">
                ...
                <v-row class="mb-2" justify="center">
                  <h3 class="tabel-tour-title">
                    <span class="red--text"> هتل سنت‌پترزبورگ:</span> 4 *
                    Holiday inn Vorota
                  </h3>
                  <h3 class="tabel-tour-title">
                    <span class="red--text mr-2"> هتل مسکو :</span> 4 * Novotel
                    moscow center
                  </h3>
                    ...
                    <template v-slot:footer>
                      <div>
                        <v-row
                          ...
                          "
                        >
                          نرخ INF (زیر 2 سال) 3.600.000 تومان + 115 دلار
                        </v-row>
                      </div>
                    </template>
                  </v-data-table>
          ...
          <!-- <div class="widthAll" v-if="tab == 0">
            ...
            <h4 class="mb-4 mt-4 mt-md-0 red--text text--darken-4">
              <v-icon size="5" color="red" class="ml-2">mdi-circle</v-icon>
              پرواز ماهان ایر رفت به مسکو و برگشت از سنت پترزبورگ
            </h4>
            <h4 class="mb-4 mt-4 mt-md-0 red--text text--darken-4">
              <v-icon size="5" color="red" class="ml-2">mdi-circle</v-icon>
              تور بصورت گروهی و لیدر فارسی زبان از تهران تا برگشت همراه مسافر می باشد.
            </h4>
            <h4 class="mb-4 mt-4 mt-md-0">
              <v-icon size="5" color="red" class="ml-2">mdi-circle</v-icon>
              ...
              <v-col cols="12" md="12">
                <ul class="mr-md-6">
                  ...
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                    6 شب اقامت در هتل با صبحانه بوفه
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                    لیدر فارسی زبان از تهران تا برگشت همراه مسافر
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                    4 روز گشت کامل 8 ساعته طبق برنامه سفر با 2 وعده ناهار
                    (بازدید از 32 مکان دیدنی - 2 روز مسکو و 2 روز سنت‌پترزبورگ)
                  </li>
                </ul>
              </v-col>
            </v-row>
          ...
          <div class="widthAll" v-else-if="tab == 3">
            <ul class="my-3 mr-9">
              ...
              <li
                class="my-3 grey--text text--darken-3 bold text-tour text-justify"
              >
                به کلیه سنین حتی کودکان زیر 2 سال مبلغ 115$ بابت ویزای توریستی
                اضافه خواهد شد.
              </li>
              <li
                class="my-3 grey--text text--darken-3 bold text-tour text-justify"
              >
                ...
                ویزای فوری 150$ و 2 روز کاری می‌باشد.
              </li>
            </ul>
          </div>
          <div class="widthAll" v-else-if="tab == 4">
            <v-row class="px-6">
              <v-col cols="12" md="6">
                <h3 class="widthAll mb-6 red--text text--darken-2">
                  برنامه سفر:
                </h3>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  <b class="grey--text text--darken-3">روز اول :</b>
                  استقبال در فرودگاه – انتقال به هتل
                </p>
                <p
                  class="my-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  <b class="grey--text text--darken-3">روز دوم :</b>
                  : گشت شهری سنت پترزبورگ (زمان گشت 10.00 الی 16.00) بازدید از
                  خیابان نوسکی – جزیره واسبلی – کلیسای کازان – بندرگاه قدیمی –
                  میدان نیکلای – میدان قیام – مجسمه کاترین – رود نوا – مجسمه
                  انیچکوف – ساختمان گمرک – کلیسای سنت اسحاق (نمای بیرونی) صرف
                  ناهار در فست فود
                </p>
                <p
                  class="my-3 grey--text text--darken-3 bold text-tour widthAll"
                ...
                >
                  ...
                  بازدید از موزه ارمیتاژ (زمان گشت از 15.00 الی 19.00) بازدید از
                  میدان قصر – گشت موزه ارمیتاژ (از داخل موزه) – بازدید از
                  فروشگاه صنایع دستی
                </p>
                <p
                  class="my-3 grey--text text--darken-3 bold text-tour widthAll"
                ...
                >
                  ...
                  پرواز به شهر مسکو حرکت به سمت فرودگاه برای انتقال به مسکو با
                  پرواز داخلی
                </p>
                <p
                  class="my-3 grey--text text--darken-3 bold text-tour widthAll"
                ...
                >
                  ...
                  : گشت مترو کرملین مسکو (زمان گشت 09.00 الی 18.00) حرکت با مترو
                  و بازدید از چند ایستگاه مترو و حرکت به سمت میدان سرخ – سرباز
                  گمنام – باغ الکساندر – نمای بیرونی کلیسای سنت باسیل – مقبره
                  لنین در صورت باز بودن – بازار گوم و ... و بازدید از کرملین (از
                  داخل کرملین) صرف ناهار در فست فود
                </p>
                <p
                  class="my-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  ...
                  گشت شهری مسکو و کشتی سواری روی رودخانه مسکو بازدید از خیابان
                  قدیمی آربات – پارک پیروزی – تپه گنجشک (بام مسکو) کلیسای عیسی
                  منجی – ساختمان امور خارجه (نای بیرونی) و کشتی سواری روی
                  رودخانه مسکو
                </p>
                <p
                  class="mt-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  <b class="grey--text text--darken-3">روز هفتم :</b>
                  حرکت به سمت فرودگاه و بازگشت به تهران
                </p>
              </v-col>
              <v-col cols="12" md="6" class="pr-md-12">
                <h3 class="red--text text--darken-2 widthAll mb-6">
                  تاریخ های اجرای تور گروهی روسیه :
                </h3>
                ...
                <p
                  ...
                  style="font-family: Byekan !important"
                >
                  1 – رفت 9 تیر و برگشت 15 تیر
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  2 - رفت 16 تیر و برگشت 22 تیر
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  3 – رفت 23 تیر و برگشت 29 تیر
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  4 – حرکت 30 تیر و برگشت 5 مرداد
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  5 – حرکت مرداد6 و برگشت 12 مرداد
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  6 – حرکت 13 مرداد و برگشت 19 مرداد
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  7 – حرکت 20 مرداد و برگشت 26 مرداد
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  8 – حرکت 27 مرداد و برگشت 2 شهریور
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  9 – حرکت 3 شهریور و برگشت 9 شهریور
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  10 – حرکت 10 شهریور و برگشت 16 شهریور
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  11 – حرکت 17 شهریور و برگشت 23 شهریور
                </p>
                <p
                  class="mt-4 mt-lg-0 mb-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  12 – حرکت 24 شهریور و برگشت 30 شهریور
                </p>
              </v-col>
            </v-row>
          </div>
              ...
              <div class="relative">
                <v-carousel v-model="imageNumber" height="100%">
                  <v-carousel-item v-for="(item, i) in moscowImages" :key="i">
                    <img class="widthAll" :src="item.src" :alt="item.title" />
                  </v-carousel-item>
                </v-carousel>
                <v-icon
...
.even-odd-tabel tbody tr:nth-child(even) {
  background-color: #0083bb29 !important;
}
...
export default {
  name: "Moscow-St.Petersburg-7days",
  components: {
    CallUs,
  },
  data: () => ({
    ...
    prices: [
      {
        ...
        calories: "49,600,000 تومان",
      },
      {
        name: "هرنفر در اتاق 1 تخته",
        calories: "48,900,000 تومان",
      },
      {
        name: "کودک با تخت 6 تا 12 ساله",
        calories: "34,500,000 تومان",
      },
      {
        name: "کودک بدون تخت",
        calories: "29,000,000 تومان",
      },
    ],
  }),
  methods: {},
