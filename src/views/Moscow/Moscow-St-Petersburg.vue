            ...
            <v-row>
              <v-col cols="12" md="6" class="pr-6 pr-sm-0">
                <ul class="mt-md-9 mr-md-6">
                  ...
                  <li class="my-3 grey--text text--darken-3 bold text-tour">
                    به کلیه سنین حتی کودکان زیر 2 سال مبلغ 100$ بابت ویزای
              ...
              <v-col cols="12" md="12">
                <ul class="mr-md-6">
                  ...
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                    پرواز بین سنت مسکو و سپترزبورگ
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                  ...
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                    9 شب اقامت در هتل با صبحانه بوفه(5 شب مسکو + 4 شب سنت
                    پترزبورگ)
                  </li>
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  ...
                  <li
                    class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi"
                  >
                    4 روز گشت کامل 8 ساعته طبق برنامه سفر با ناهار (بازدید از 35
                    مکان دیدنی - 2 روز مسکو و 2 روز سنت‌پترزبورگ)
                  </li>
                </ul>
              </v-col>
            </v-row>
          ...
          <div class="widthAll" v-else-if="tab == 3">
            <ul class="my-3 mr-9">
              ...
              <li
                class="my-3 grey--text text--darken-3 bold text-tour text-justify"
              >
                به کلیه سنین حتی کودکان زیر 2 سال مبلغ 100$ بابت ویزای توریستی
                اضافه خواهد شد.
              </li>
              <li
                class="my-3 grey--text text--darken-3 bold text-tour text-justify"
            ...
            <v-row class="px-6">
              <v-col cols="12">
                ...
                >
                  ...
                  حرکت با مترو و بازدید از چند ایستگاه مترو و حرکت به سمت میدان
                  سرخ – سرباز گمنام – باغ الکساندر – نمای بیرونی کلیسای سنت
                  باسیل – مقبره لنین و در صورت باز بودن فروشگاه تاریخی گوم و ...
                  و بازدید از کرملین(از داخل کرملین)-صرف ناهار فست فود
                </p>
                <p
                  class="my-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  ...
                  گشت شهری مسکو – بازدید از خیابان قدیمی اربات – پارک پیروزی –
                  تپه گنجشک (بام مسکو) – کلیسای منجی – ساختمان امور خارجه (نمای
                  بیرونی) - صرف ناهار فست فود
                </p>
                <p
                  class="my-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                ...
                >
                  ...
                  پرواز به سمت شهر سنت پترزبورگ - حرکت به سمت فرودگاه برای
                  انتقال به شهر سنت پترزبورگ (طول مسیر حداقل یک ساعت)
                </p>
                <p
                  class="my-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  ...
                  گشت شهری سنت پترزبورگ و بازدید از موزه ارمیتاژ - بازدید از
                  خیابان نوسکی – جزیره واسیلی – کلیسای کازان – بندرگاه قدیمی –
                  میدان نیکلای – میدان قیام – مجسمه کاترین – رود نوا – مجسمه
                  انیچکوف – صرف ناهار - ساختمان گمرک - کلیسای سنت اسحاق (نمای
                  بیرونی) - میدان قصر - گشت موزه هرمیتاژ(از داخل موزه) – بازدید
                  از فروشگاه صنایع دستی
                </p>
                <p
                ...
                >
                  ...
                  گشت شب سنت‌پترزبورگ با قایق سواری بهمراه شام در رستوران -
                  بازدید از نمای بیرونی کلیسای خون ریخته شده در نور پردازی شب
                  -یک ساعت و نیم قایق سواری در رودخانه نوا و کانال های
                  سنت‌پترزبورگ و باز شدن پل ها - بازدید از پل های معروف شهر
                </p>
                <p
                  class="my-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
                >
                  ...
                  زمان آزاد و استفاده از برنامه های اختیاری(باله دریاچه قو - بتغ
                  پترهوف - بازدید از کاخ و باغ پوشکین)
                </p>
                <p
                  class="mt-3 grey--text text--darken-3 bold text-tour widthAll"
                  style="font-family: Byekan !important"
