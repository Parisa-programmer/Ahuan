  ...
  <div class="mt-9 mt-sm-12 pt-12">
          <v-row justify="center">
            <div class="widthAll relative">
              <img class="widthAll backgroundImageTour" src="@/assets/image/tour/tour-background26.jpg" alt="">
              <div class="tourImageBackground"></div>
            </div>
            <div class="mb-12 indexDiv main-div" style="z-index: 3">
              <div>
                <span class="white--text countryNmae px-12">کوالالامپور - پوکت - بانکوک</span>
              </div>
              <div>
                <b class="white--text px-12 tour-date">
                  تاریخ حرکت : 1 فروردین
                </b>
              </div>
                  ...
                  <v-row>
                    <v-col cols="12" md="12">
                      <ul class=" mr-md-6">
                        ...
                        <li class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi">پرواز های داخلی و خارجی</li>
                        ...
                        <li class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi">10 شب اقامت به‌همراه صبحانه</li>
                        <li class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi">گشت شهری 4 ساعته در تمامی شهرها</li>
                        <li class="my-3 grey--text text--darken-3 bold text-tour d-inline-block halfLi">پرواز کویتی به‌همراه اقامت در هتل 5 ستاره فرودگاه کویت در رفت و برگشت</li>
                      </ul>
                    </v-col>
                  </v-row>
                </div>
                  ...
                  <v-row>
                    <v-col cols="12" md="12">
                      ...
                      <ul class="my-6 mr-9">
                        ...
                        <li class="my-3 grey--text text--darken-3 bold text-tour text-justify">تمکن مالی 6 ماهه با موجودی حداقل 50.000.000 تومان مهر برجسته</li>
                  ...
                  <v-row>
                    <v-col cols="12" md="6">
                      ...
                      <ul class="my-6 mr-9">
                        ...
                        <li class="my-3 grey--text text--darken-3 bold text-tour text-justify">تزریق هر دو نوبت واکسن الزامیست یا تست PCR سه روز قبل از پرواز ضروری است.</li>
                        <li class="my-3 grey--text text--darken-3 bold text-tour text-justify">نرخ کودک زیر 2 سال (INF) 14.000.000 تومان می‌باشد.</li>
                        <li class="my-3 grey--text text--darken-3 bold text-tour text-justify">پرداخت 70% کل مبلغ تور الزامیست در غیر این صورت چنانچه نوسانات دلار بالای 5% باشد شامل مسافرین محترم می‌شود.</li>
...
export default {
  ...
  data: () => ({
    ...
    images: [
      {
        src: require('@/assets/image/tour/تایلند-مالزی000-1.jpg'),
        title: 'Phra Nang Beach'
      },
      {
        src: require('@/assets/image/tour/تایلند-مالزی000-2.jpg'),
        title: 'Wiang kum kam'
      },
      {
        src: require('@/assets/image/tour/تایلند-مالزی000-3.jpg'),
        title: 'Khao Sok National Park'
      },
      {
        src: require('@/assets/image/tour/تایلند-مالزی000-4.jpg'),
        title: 'Cameron Highlands'
      },
      {
        src: require('@/assets/image/tour/تایلند-مالزی000-5.jpg'),
        title: 'Kuala lampur'
      },
      {
        src: require('@/assets/image/tour/تایلند-مالزی000-6.jpg'),
        title: 'Kuala lampur'
      },
    ],
    imageNumber: 0,
