...
export default {
  ...
  methods: {
    getTest() {
      // "http://" + Nira.baseUrl_ata_Availability + "/AvailabilityJS.jsp?AirLine=I3&cbSource=" + src + "&cbTarget=" + dest + "&cbDay1=" + day + "&cbMonth1=" + month + "&cbAdultQty=" + adl + "&cbChildQty=" + chd + "&cbInfantQty=" + inf + "&OfficeUser=" + Nira.ataUserName + "&OfficePass=" + Nira.ataPassword;
      axios.get('http://restapi.iaa.ir/ws1/AvailabilityJS.jsp?AirLine=ATA&cbSource=UGT&cbTarget=TTQ&cbDay1=30&cbMonth1=07&DepartureDate=2021-10-18&cbAdultQty=1&cbChildQty=0&cbInfantQty=0&OfficeUser=THR155.WS&OfficePass=Ahuan1348')
