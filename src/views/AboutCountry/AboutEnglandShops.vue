        ...
        <div class="indexDiv">
              ...
              <v-row class="heightAll" align="center">
                <div class="px-sm-6 relative">
                  ...
                  <div style="z-index:222">
                    <h2 class="font-small-title-xs mb-3">بزرگترین مراکز خرید در انگلستان</h2>
                    <ul class="mt-12 mr-6">
                      <li>بلوواتر - کنت</li>
                      <li class="mt-2">وست فیلد - لندن</li>
                      <li class="mt-2">متروسنتر - گیتزهد</li>
                      <li class="mt-2">ترافورد سنتر - منچستر</li>
                      <li class="mt-2">وستفیلد استرافورد سیتی - لندن</li>
                      <li class="mt-2">بولرینگ و گرند سنترال - بیرمنگام</li>
                    </ul>
                  </div>
                </div>
              </v-row>
          ...
          <v-row>
            ...
            <p class="text-justify mt-6 mx-3 answerText">
              ...
              هکتار پارک فوق‌العاده جذاب احاطه شده که شامل پیاده‌روی Mosaic Gallery Tunnel میشه که در انتها به دریاچه
            ...
            <p class="text-justify mt-6 mx-3 answerText">
              ...
              فوق‌العاده و بی‌نظیر باشید این مکان شما رو راضی می‌کنه. فراموش نکنید وقتی اینجا میاید حتما یه عکس کنار گاو
              نر برنزی 6 تنی این مرکز بگیرید! البته این گاو برنزی جزء 10 اثر برتر هنر اجتماعی از سال 2003 تا کنون هست.
            </p>
          </v-row>
        </div>
      </v-row>
